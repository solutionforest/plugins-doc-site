  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <h1 className="text-2xl font-bold">Documentation Error</h1>

        <p className="text-muted-foreground">
          We encountered an error while loading this documentation page. This might be due to a temporary issue.
        </p>
