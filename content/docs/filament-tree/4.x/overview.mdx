...
lastUpdated: 2026-04-20T10:04:36Z
---

<Callout type="warn">
  Please note that we will only be updating to version 4.x, excluding any bug
  fixes.
</Callout>
...
<Callout type="warn">
  We only provide updates for versions 3.x, excluding bug fixes for older
  versions.
</Callout>
