...
lastUpdated: 2026-03-02T10:58:34.375Z
---
...
![Sample](/images/filament-cms-website-plugin/assets/screenshots/list-cms-pages.png)
...
5. By default, the index page of the website has a slug of **home**. If you wish to customize this slug, you can update the `models.cms_page` parameter in the `config/filament-cms.php` file and modify your CmsPage model accordingly. Specifically, you will need to change the value of the `HOME_SLUG` constant property to your desired slug. Once you have made these changes, run the `php artisan optimize:clear command` to clear the cache.
   ...
   ![Custom index slug for cms page](/images/filament-cms-website-plugin/assets/screenshots/customize-cms-page-model-1.png)
...
![Create basic draft page](/images/filament-cms-website-plugin/assets/screenshots/create-draft-page.gif)

### Publish draft page

![Publish draft page](/images/filament-cms-website-plugin/assets/screenshots/publish-draft-page.gif)

### Un-publish published page

![Un-publish published page](/images/filament-cms-website-plugin/assets/screenshots/unpublish-published-page.gif)
